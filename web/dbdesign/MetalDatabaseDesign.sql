drop table METAL.ORDERED_ITEMS;
drop table METAL.ORDERS;
...
ALTER TABLE METAL.ORDERS ADD FOREIGN KEY (USER_ID) REFERENCES METAL.USERS (ID);
ALTER TABLE METAL.ORDERED_ITEMS ADD FOREIGN KEY (ITEM_ID) REFERENCES METAL.ITEMS (ID);
ALTER TABLE METAL.ORDERED_ITEMS ADD FOREIGN KEY (ORDER_ID) REFERENCES METAL.ORDERS (ID);
ALTER TABLE METAL.ORDERED_ITEMS ADD FOREIGN KEY (SIZE_ID) REFERENCES METAL.SIZES (ID);
